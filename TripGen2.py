# This file contains the iteration in which students study at various universities
import numpy as np
import pandas as pd
import random
# importing Data
...
# assumption1 - if they are above 18, university, paris - not valid in this iteration

# study in 75
# 46% of ile de france uni students study in 75
# from the other 54% , 71% studies in either 95, 77, 94, 91, 78, 92, 91, 93, 93

studying_locations = np.array(["75", "77", "78", "91", "92", "93", "94", "95"])
p_study = (0.5011, 0.0408, 0.0535, 0.0646, 0.1208, 0.0827, 0.0888, 0.0477)
for i in range(len(((df3["following_purpose"] == "education") | (df3["preceding_purpose"] == "education")))):
    a = np.random.choice(studying_locations, replace=False, p=p_study)
    if (df3.loc[i, "following_purpose"] == "education") | (df3.loc[i, "preceding_purpose"] == "education"):
        df3.loc[i, "workplace"] = a
